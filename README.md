...
<p align="center">
  <img src="assets/bookender-studio-icon.png" width="180" alt="Book Wunderwaffe Studio icon" />
</p>
...
![Version](https://img.shields.io/badge/version-3.0.0-c479ff?style=flat-square)
...
Book Wunderwaffe Studio — локальная многопроектная desktop-экосистема для написания
...
- живой аудиореактивный спектр с чувствительными колонками и переливающимся градиентом в предпросмотре и финальном видео;
...
- спектр строится из реального аудио во время кодирования, а визуальная ветка усиливается отдельно и не меняет мастер-звук;
